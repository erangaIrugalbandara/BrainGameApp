...
export default function Game2MenuScreen({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.instructions}>Identify the color of the text, not the word itself!</Text>
      ...
      <TouchableOpacity style={styles.navButton} onPress={() => navigation.navigate('Records', { gameId: 2 })}>
...
const styles = StyleSheet.create({
  ...
  levelButton: { flexDirection: 'row', justifyContent: 'space-between', width: '80%', backgroundColor: '#DC3545', padding: 15, borderRadius: 10, marginBottom: 10 },
